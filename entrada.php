...
<html lang="pt-br">
    ...
    <body>        
      ...
      <div class="reg entrada">          
          <h1>Entrada: <?php echo $sessao->getDescLocal(); ?></h1>
          <form method="POST" action="#">          
          <input type="text" name="ra" placeholder=" Ra aqui" required autocomplete="off" autofocus>
          ...
          <div class='resultado'>
            <?php
                if(isset($_POST['confirmar'])){
                    ...
                    $entrada = new Enter($ra, $local, null,turno());
                    $consulta= new EnterPdo();                    
                    $dados = $consulta->insert($entrada);
          ...
          <form method="POST" action="#">
            <?php
                ...
                if (isset($_POST['verificar'])) {
                    ...
                    echo "<button  class='btn btn-success ' type='submit'  name='confirmar'>Confirmar Entrada</button>";
