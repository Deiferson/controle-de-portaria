    ...
    <body>        
        ...
        <div class="container">
            <ul class="nav nav-tabs">
              <li role="presentation" class="active"><a href="cp_relatorio.php">Entrada e Saída</a></li>
              <li role="presentation" ><a href="cp_relatorio_E.php">Apenas entraram</a></li>
	      <li role="presentation" ><a href="cp_relatorio_S.php">Apenas Saíram</a></li>
			...
			$consulta = new RelatorioPdo();
                    ...
                    <tr class="row">
						...
						<td ><?php echo $temp['entrada'] ?></td>
						<td ><?php echo $temp['saida'] ?></td> 
                    </tr>
                    <?php }?>
                </tbody>
            </table>
